...
<html lang="en">
  <head>
	...
	<script>
		...
		{
			window.location='featureDelete.php?featureid=<?php echo $_GET["featureid"];?>&Action=ConfirmDelete'; 
		}
	...
	?>
		<div class="container">
			<div class="page-header">
				<h3>Confirm Deletion of Property Feature</h3>
			  </div>
			  <div class="row">
				<div class="col-md-6">
				  <table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td><input class="btn btn-sm btn-info btn-block" type="button" value ="Return to List" OnClick="window.location='feature.php'"></td>
						</tr>
				...
				<div class="col-4">
					...
					<input  class="btn btn-sm btn-info" type="button" value="Go to Feature Page"
				...
				<p class="text-success bg-success text-center">
					The property feature was successfully deleted
				</p>
				</div>
				</div>
				</div>
