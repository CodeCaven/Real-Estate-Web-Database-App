...
<html lang="en">
  <head>
	...
	<!-- 2DO TYPE-->
	<!--   consistency in error update displays-->
			...
			<div class="col-md-6">
			  <table class="table">
				...
				<?php
					...
					?>
						<tr>
							<td><?php echo $line["TYPE_ID"]; ?></td>
							<td><?php echo $line["TYPE_NAME"]; ?></td>
							<td><a href="typeUpdate.php?typeid=<?php echo $line["TYPE_ID"]; ?>&Action=Update">Update</a></td>
							<td><a href="typeDelete.php?typeid=<?php echo $line["TYPE_ID"]; ?>&Action=Delete">Delete</a></td>
						</tr>
						<?php
					}
					?> 
